...
set_target_properties(drsyscall PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/drmf/lib32/debug/drsyscall.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "drsyms;ntdll_imports"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "dynamorio;drmgr;drcontainers"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/drmf/lib32/debug/drsyscall.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS drsyscall )
list(APPEND _IMPORT_CHECK_FILES_FOR_drsyscall "${_IMPORT_PREFIX}/drmf/lib32/debug/drsyscall.lib" "${_IMPORT_PREFIX}/drmf/lib32/debug/drsyscall.dll" )
...
set_target_properties(drsyscall_static PROPERTIES
  ...
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "libcpmtd;libcmtd;dynamorio;drmgr_static;drcontainers;drsyms_static;drfrontendlib;ntdll_imports"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/drmf/lib32/debug/drsyscall_static.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS drsyscall_static )
list(APPEND _IMPORT_CHECK_FILES_FOR_drsyscall_static "${_IMPORT_PREFIX}/drmf/lib32/debug/drsyscall_static.lib" )
...
set_target_properties(drsymcache PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/drmf/lib32/debug/drsymcache.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "drsyms"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "dynamorio;drmgr"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/drmf/lib32/debug/drsymcache.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS drsymcache )
list(APPEND _IMPORT_CHECK_FILES_FOR_drsymcache "${_IMPORT_PREFIX}/drmf/lib32/debug/drsymcache.lib" "${_IMPORT_PREFIX}/drmf/lib32/debug/drsymcache.dll" )
...
set_target_properties(drsymcache_static PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/drmf/lib32/debug/drsymcache_static.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS drsymcache_static )
list(APPEND _IMPORT_CHECK_FILES_FOR_drsymcache_static "${_IMPORT_PREFIX}/drmf/lib32/debug/drsymcache_static.lib" )
...
set_target_properties(umbra PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/drmf/lib32/debug/umbra.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "ntdll_imports"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "dynamorio;drmgr;drcontainers"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/drmf/lib32/debug/umbra.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS umbra )
list(APPEND _IMPORT_CHECK_FILES_FOR_umbra "${_IMPORT_PREFIX}/drmf/lib32/debug/umbra.lib" "${_IMPORT_PREFIX}/drmf/lib32/debug/umbra.dll" )
...
set_target_properties(umbra_static PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "C"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "libcmtd;dynamorio;drmgr_static;drcontainers;ntdll_imports"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/drmf/lib32/debug/umbra_static.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS umbra_static )
list(APPEND _IMPORT_CHECK_FILES_FOR_umbra_static "${_IMPORT_PREFIX}/drmf/lib32/debug/umbra_static.lib" )
...
set_target_properties(drfuzz PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/drmf/lib32/debug/drfuzz.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "dynamorio;drwrap;drmgr;drcontainers"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/drmf/lib32/debug/drfuzz.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS drfuzz )
list(APPEND _IMPORT_CHECK_FILES_FOR_drfuzz "${_IMPORT_PREFIX}/drmf/lib32/debug/drfuzz.lib" "${_IMPORT_PREFIX}/drmf/lib32/debug/drfuzz.dll" )
...
set_target_properties(drfuzz_static PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/drmf/lib32/debug/drfuzz_static.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS drfuzz_static )
list(APPEND _IMPORT_CHECK_FILES_FOR_drfuzz_static "${_IMPORT_PREFIX}/drmf/lib32/debug/drfuzz_static.lib" )
