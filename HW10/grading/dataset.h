 ...
 * img_dt will be
 * - printed out (trivial)
 * - shifted (crop and pad)
 * - resized (using nearest neighbour)
 * - cropped (best implemented using subarray)
 * - padded (best implemented using +)
 * implemented as deque<deque<uint8_t>>
 */
