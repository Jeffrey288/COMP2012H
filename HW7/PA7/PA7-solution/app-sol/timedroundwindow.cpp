    ...
    RoundWindow(parent), minutes(minutes)
{
    ...
    dynamic_cast<QVBoxLayout*>(ui->centralwidget->layout())->insertLayout(1, timerLayout);
    ...
    timerLayout->addWidget(timerLineEdit, 0, 0);

    skipWordPushButton = new QPushButton("Skip word");
    ...
    timerLayout->addWidget(skipWordPushButton, 0, 1);
    ...
    timerLayout->addWidget(messageLineEdit, 1, 1);
    ...
    timerLayout->addWidget(scoreLineEdit, 1, 0);
}
