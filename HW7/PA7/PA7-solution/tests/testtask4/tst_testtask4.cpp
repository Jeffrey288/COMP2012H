...
void TestTask4::testSwitchModeRAMT() {
    MainWindow w;
...
void TestTask4::testSwitchModeRMAT() {
    MainWindow w;
...
void TestTask4::testSwitchModeRTAM() {
    MainWindow w;
...
void TestTask4::testSwitchModeRTMA() {
    MainWindow w;
...
void TestTask4::testStartRegularRound() {
    ...
    w.curRound->hide();
    QCOMPARE(w.curRound->wr->getLength(), 7);
}
