...
#include <memory>
#include "../../../../PA7-solution/tests/testbonustask5/tst_testbonustask5.h"
...
static const qt_meta_stringdata_TestBonusTask5_t qt_meta_stringdata_TestBonusTask5 = {
    {
        ...
        QT_MOC_LITERAL(15, 24),  // "testDummyAnswerGetRandom"
        QT_MOC_LITERAL(40, 0),  // ""
        QT_MOC_LITERAL(41, 21),  // "testDummyAnswerGetAll"
        QT_MOC_LITERAL(63, 23),  // "testReadAnswerFile_data"
        QT_MOC_LITERAL(87, 18)   // "testReadAnswerFile"
    },
    "TestBonusTask5",
    "testDummyAnswerGetRandom",
    "",
    "testDummyAnswerGetAll",
...
void TestBonusTask5::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->testDummyAnswerGetRandom(); break;
        case 1: _t->testDummyAnswerGetAll(); break;
        case 2: _t->testReadAnswerFile_data(); break;
        case 3: _t->testReadAnswerFile(); break;
        default: ;
        }
    }
    (void)_a;
